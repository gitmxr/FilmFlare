...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn about FilmFlare — your platform for discovering movies, trailers, and music.",
};
    ...
    <div className="min-h-screen bg-gray-900 p-6 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mb-4 text-gray-400">
          ...
          hardcore cinephile, FilmFlare is designed to enhance your movie journey.
        </p>
        ...
        <p className="mb-4 text-gray-400">
          ...
          FilmFlare offers a sleek, fast, and responsive entertainment experience.
        </p>
